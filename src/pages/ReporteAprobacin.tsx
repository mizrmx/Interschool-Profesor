...
import styles from "./ReporteAprobacin.module.css";

const ReporteAprobacin: FunctionComponent = () => {
  return (
    <div className={styles.reporteAprobacin}>
      ...
      <div className={styles.education}>
        ...
        <div className={styles.consulta}>
          ...
          <div className={styles.idProfesor}>
            <div className={styles.nombre1}>ID Profesor</div>
          ...
          <div className={styles.periodo}>
            <div className={styles.nombre1}>Periodo</div>
          ...
          <div className={styles.nivel}>
            <div className={styles.nombre1}>Nivel</div>
          ...
          <div className={styles.ciclo}>
            <div className={styles.nombre1}>Ciclo</div>
            <div className={styles.input1}>
              <div className={styles.calendarioItem} />
        ...
        <div className={styles.title}>
          ...
          <b className={styles.reporteAprobacin1}>Reporte Aprobación</b>
        </div>
      </div>
    </div>
  );
